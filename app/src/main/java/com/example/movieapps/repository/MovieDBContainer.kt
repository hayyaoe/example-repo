...
class MovieDBContainer {
    ...
    private val BASE_URL = "https://api.movidb.org/3/movie/"
    private val ACESS_TOKEN = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkNjMxMDRjNGMwOWJiN2RhN2I5MDZiMTIzYTU1YTg0MiIsInN1YiI6IjY1MzZlZWI0N2ZjYWIzMDEyYzIyOGFiYiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.p5XqKHoXPa5z-ah6Z3P1qGeX1SFdBOj_RtxwtxYW4-o"
    private val client = OkHttpClient.Builder()
        .addInterceptor(AuthInterceptor(ACESS_TOKEN))
        .build()
